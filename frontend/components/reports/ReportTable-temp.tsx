...
const TEXTS = {
  ...
  buttonShowOnlyPending: {
    ...
    hr: 'Mostrar apenas pendentes',
    sl: 'Mostrar apenas pendentes',
    el: 'Mostrar apenas pendentes',
  },
  buttonExcel: {
    it: 'Excel',
    en: 'Excel',
  ...
  messageNoDocuments: {
    ...
    hr: 'Nenhum documento encontrado',
    sl: 'Nenhum documento encontrado',
    el: 'Nenhum documento encontrado',
  },
  labelTotal: {
    it: 'TOTALE',
    en: 'TOTAL',
  ...
  columns: {
    ...
    column_cky_cnt_clfr: {
      ...
      hr: 'Código do cliente',
      sl: 'Código do cliente',
      el: 'Código do cliente',
    },
    ...
    column_sigla_trasf: {
      ...
      hr: 'Sigla doc armazém',
      sl: 'Sigla doc armazém',
      el: 'Sigla doc armazém',
    },
    column_numero_trasf: {
      ...
      hr: 'Número doc armazém',
      sl: 'Número doc armazém',
      el: 'Número doc armazém',
    },
    column_data_trasf: {
      it: 'Data trasf',
      en: 'Transfer date',
    ...
    column_origne: {
      ...
      hr: 'Atendido ou em pedido',
      sl: 'Atendido ou em pedido',
      el: 'Atendido ou em pedido',
    },
    column_sco_1: {
      it: 'Sco 1',
      en: 'Disc 1',
